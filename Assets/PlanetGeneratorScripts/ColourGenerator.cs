...
public class ColourGenerator {
    ...
    public float BiomePercentFromPoint(Vector3 pointOnUnitShpere)
    {
        float heightPercent = (pointOnUnitShpere.y + 1) / 2f;

        heightPercent += (biomeNoiseFilter.Evaluate(pointOnUnitShpere) - settings.biomeColourSettings.noiseOffset) * settings.biomeColourSettings.noiseStrengh;
